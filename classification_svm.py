...
X_train, X_test, y_train, y_test = train_test_split(guidelinePrices, isAbnormal, test_size=0.1, random_state=42)  #9000 records are used for training and 1000 records are used for testing.
classifier = SVC(kernel='linear', random_state = 42)
classifier.fit(X_train, y_train)

#testing the remaining training data(1000)
